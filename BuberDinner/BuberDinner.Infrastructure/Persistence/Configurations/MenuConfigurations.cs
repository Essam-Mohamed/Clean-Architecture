...
namespace BuberDinner.Infrastructure.Persistence.Configurations
{
    public sealed class MenuConfigurations : IEntityTypeConfiguration<Menu>
    {
        ...
        {
            ConfigurationMenuTable(builder);
            ConfigurationMenuSectionsTable(builder);
            ConfigurationMenuDinnersIdsTable(builder);
            ConfigurationMenuReviewIdsTable(builder);
        }

        private void ConfigurationMenuReviewIdsTable(EntityTypeBuilder<Menu> builder)
        {
        ...
        private void ConfigurationMenuDinnersIdsTable(EntityTypeBuilder<Menu> builder)
        {
        ...
        private void ConfigurationMenuTable(EntityTypeBuilder<Menu> builder)
        {
